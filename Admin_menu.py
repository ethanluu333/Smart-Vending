...
class Admin:
    ...
    def admin_main_menu(self):
        ...
        self.mframe.grid(column=0, row=1, columnspan=1, rowspan=14)

        image1 = Image.open("images/user.png")
        resize_image1 = image1.resize((50, 50))
        self.mi1 = ImageTk.PhotoImage(resize_image1)
        self.accounts = Button(self.mframe, image=self.mi1, border=0, bg=NAV_COLOR, command=self.buildusertable)
        self.accounts.grid(column=0, row=1, padx=15, pady=(20, 0))
        self.label1 = Label(self.mframe, text="Profile", bg=NAV_COLOR, fg=NAV_TEXT_COLOR)
        ...
        self.label2 = Label(self.mframe, text="Sales", bg=NAV_COLOR, fg=NAV_TEXT_COLOR)
        ...
        self.stocks = Button(self.mframe, image=self.mi3, border=0, bg=NAV_COLOR, command=self.buildprodtable)
        self.stocks.grid(column=0, row=5, pady=(10, 0))
        self.label3 = Label(self.mframe, text="Inventory", bg=NAV_COLOR, fg=NAV_TEXT_COLOR)
        ...
        self.items = Button(self.mframe, image=self.mi4, border=0, bg=NAV_COLOR, command=self.additems)
        self.items.grid(column=0, row=7, pady=(10, 0))
        self.label4 = Label(self.mframe, text="Add Items", bg=NAV_COLOR, fg=NAV_TEXT_COLOR)
        ...
        self.changeuser = Button(self.mframe, image=self.mi5, border=0, bg=NAV_COLOR)
        self.changeuser.grid(column=0, row=9, pady=(10, 0))
        self.label5 = Label(self.mframe, text="Sign Out", bg=NAV_COLOR, fg=NAV_TEXT_COLOR)
        ...
        self.logout = Button(self.mframe, image=self.mi6, border=0, bg=NAV_COLOR)
        self.logout.grid(column=0, row=11, pady=(10, 0))
        self.label6 = Label(self.mframe, text="Quit", bg=NAV_COLOR, fg=NAV_TEXT_COLOR)
        ...
        self.searchbut = Button(self.searchframe, text="Search Description", font="roboto 14", border=0, fg="white", bg="#57a1f8",
        ...
        self.searchentry = MyEntry(self.searchframe, textvariable=self.searchvar, font="roboto 14", width=25, 
                                   bg="#FFFFFF", highlightbackground="#57a1f8", highlightthickness=2)
        ...
        self.resetbut = Button(self.searchframe, text="Reset", font="roboto 14", border=0, fg="white", bg="#57a1f8", width=8,
    ...
    def buildprodtable(self):
        ...
        for i in range(0, 6):
            Label(self.formframe, text=l1[i], font="roboto 14", bg="#FFFFFF").place(x=0, y=va)
            va += 60
        Entry(self.formframe, textvariable=self.itemeditv, font="roboto 14", bg="#FFFFFF", width=20, highlightbackground="#57a1f8", highlightthickness=2).place(x=142, y=0,
                                                                                                           height=40)
        Entry(self.formframe, textvariable=self.itemeditdescv, font="roboto 14", bg="#FFFFFF", width=20, highlightbackground="#57a1f8", highlightthickness=2).place(x=142,
                                                                                                               y=60,
                                                                                                               height=40)
        x = MyEntry(self.formframe, textvariable=self.itemeditcatv, font="roboto 14", bg="#FFFFFF", width=20, highlightbackground="#57a1f8", highlightthickness=2)
        ...
        Entry(self.formframe, textvariable=self.itemeditpricev, font="roboto 14", bg="#FFFFFF", width=20, highlightbackground="#57a1f8", highlightthickness=2).place(
                                                                                                            x=142,
                                                                                                            y=180,
                                                                                                            height=40)
        Entry(self.formframe, textvariable=self.itemeditstockv, font="roboto 14", bg="#FFFFFF", width=20, highlightbackground="#57a1f8", highlightthickness=2).place(
                                                                                                            x=142,
                                                                                                            y=240,
                                                                                                            height=40)
        Entry(self.formframe, textvariable=self.addstock, font="roboto 14", bg="#FFFFFF", width=20, highlightbackground="#57a1f8", highlightthickness=2).place(x=142, y=300,
                                                                                                          height=40)
        Button(self.formframe, text="Update", font="roboto 14", border=0, fg="white", bg="#57a1f8", width=10, height=2,
               command=self.changeprodtable).place(x=105, y=361)
        Button(self.formframe, text="Remove", font="roboto 14", border=0, fg="white", bg="#57a1f8", width=10, height=2,
    ...
    def mainsearch(self, f):
        ...
        if f == 1:
            ...
            self.statbutton = Button(self.searchframe, text="Analytics", font="roboto 14", border=0, fg="white", bg="#57a1f8", width=9, command=showanalytics)
            self.statbutton.place(x=600, y=23)
            self.cur.execute("select product_desc from products")
            li = self.cur.fetchall()
            a = []
            for i in range(0, len(li)):
    ...
    def additems(self):
        ...
        for i in range(0, len(list_)):
            Label(self.itemframe, text=list_[i], font="roboto 14 bold", bg="#ffffff").grid(row=i, column=0, pady=15,
                                                                                           sticky="w")
        Entry(self.itemframe, width=40, textvariable=self.newitemcode, font="roboto 11", bg="#ffffff", highlightbackground="#57a1f8", highlightthickness=2).grid(row=0,
                                                                                                            column=1,
                                                                                                            pady=15,
                                                                                                            padx=10,
                                                                                                            ipady=3)
        Entry(self.itemframe, width=40, textvariable=self.newitem, font="roboto 11", bg="#ffffff", highlightbackground="#57a1f8", highlightthickness=2).grid(row=1, column=1,
                                                                                                        pady=15,
                                                                                                        padx=10,
                                                                                                        ipady=3)
        Entry(self.itemframe, width=40, textvariable=self.newitemdesc, font="roboto 11", bg="#ffffff", highlightbackground="#57a1f8", highlightthickness=2).grid(row=2,
                                                                                                            column=1,
                                                                                                            pady=15,
                                                                                                            padx=8,
                                                                                                            ipady=3)
        cat = MyEntry(self.itemframe, width=40, textvariable=self.newitemcat, font="roboto 11", bg="#ffffff", highlightbackground="#57a1f8", highlightthickness=2)
        cat.grid(row=3, column=1, pady=15, padx=10, ipady=3)
        Entry(self.itemframe, width=40, textvariable=self.newitemprice, font="roboto 11", bg="#ffffff", highlightbackground="#57a1f8", highlightthickness=2).grid(row=4,
                                                                                                             column=1,
                                                                                                             pady=15,
                                                                                                             padx=10,
                                                                                                             ipady=3)
        Entry(self.itemframe, width=40, textvariable=self.newitemstock, font="roboto 11", bg="#ffffff", highlightbackground="#57a1f8", highlightthickness=2).grid(row=5,
                                                                                                             column=1,
                                                                                                             pady=15,
                                                                                                             padx=10,
                                                                                                             ipady=3)
        ...
        Button(self.itemframe, text="Add item", height=3,font="roboto 14", border=0, fg="white", bg="#57a1f8", command=self.insertitem).grid(row=6,
                                                                                                            column=1,
                                                                                                            pady=10,
                                                                                                            padx=12,
                                                                                                            sticky="w",
                                                                                                            ipadx=10)
        Button(self.itemframe, text="Back", height=3, font="roboto 14", border=0, fg="white", bg="#57a1f8", width=8, command=self.buildprodtable).grid(
    ...
    def buildusertable(self):
        ...
        for i in range(0, 3):
            ...
            va += 70
        Entry(self.formframe1, textvariable=self.usernamedit, font="roboto 14", bg="#FFFFFF", width=25,highlightbackground="#57a1f8", highlightthickness=2,
              state='readonly').place(x=162, y=105, height=40)
        Entry(self.formframe1, textvariable=self.passwordedit, font="roboto 14", bg="#FFFFFF", width=25, highlightbackground="#57a1f8", highlightthickness=2).place(
                                                                                                        x=162,
                                                                                                        y=175,
                                                                                                        height=40)
        ...
        Button(self.formframe1, text="Create a User", font="roboto 14", border=0, fg="white", bg="#57a1f8", width=12, height=2,
               command=self.adduser).place(x=0, y=10)
        Button(self.formframe1, text="Update",  font="roboto 14", border=0, fg="white", bg="#57a1f8", width=10, height=2,
               command=self.changeusertable).place(x=145, y=381)
        Button(self.formframe1, text="Remove", font="roboto 14", border=0, fg="white", bg="#57a1f8", width=10, height=2,
    ...
    def getsales(self):
        ...
        for i in range(0, len(saleslist)):
            ...
            saleslist[i] = [saleslist[i][0], saleslist[i][1], saleslist[i][2], list_[0][0], saleslist[i][3],
                            list_[0][1] * (int(saleslist[i][3])), saleslist[i][4], saleslist[i][5]]
